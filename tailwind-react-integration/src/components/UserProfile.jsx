...
const UserProfile = () => {
  return (
    <div className=" user-profile hover:shadow-xl bg-gray-100 sm:p-4 md:p-8 ms:max-w-xs  md:max-w-sm mx-auto,ms:my-10 md:my-20 rounded-lg shadow-lg">
        ...
        <h1 className="hover:text-blue-500 md:text-xl ms:text-lg text-blue-800 my-4">John Doe</h1>
